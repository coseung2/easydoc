...
export const strings = {
  zh: {
    ...
    easyDocConnect: '连接手机',
    easyDocManage: '管理手机',
    easyDocConnected: '已连接',
    easyDocWaiting: '等待连接',
    easyDocPairHelp: '用手机相机扫描二维码，然后在 EasyDoc 中打开。',
    easyDocAutoOpen: '收到后自动打开',
    easyDocDisconnect: '解除连接',
    ...
    setSecAbout: '关于',
    setSecAiModel: 'AI 模型',
    setAiAuthMethod: '验证方式',
    setAiOAuthHint: '通过 ChatGPT 账号使用订阅方案提供的模型。',
    setAiOAuthPending: '等待在浏览器中完成登录。',
    setAiOAuthConnected: '已连接 ChatGPT',
    setAiOAuthDisconnected: '尚未连接 ChatGPT',
    setAiOAuthError: '无法完成登录，请重试。',
    setAiOAuthOpenBrowser: '打开浏览器',
    setAiOAuthStorage: '安全凭据存储不可用。',
    setAiOAuthPort: '登录端口正被占用，请关闭其他登录窗口后重试。',
    setAiProvider: '模型服务商',
    setAiModelId: '模型',
    setAiApiKey: 'API Key',
  ...
  en: {
    ...
    easyDocConnect: 'Connect phone',
    easyDocManage: 'Manage phones',
    easyDocConnected: 'Connected',
    easyDocWaiting: 'Waiting for phone',
    easyDocPairHelp: 'Scan this QR code with your phone camera, then open it in EasyDoc.',
    easyDocAutoOpen: 'Open received files automatically',
    easyDocDisconnect: 'Disconnect',
    ...
    setAiAuthMethod: 'Authentication',
    setAiOAuthHint: 'Use models available to your plan with your ChatGPT account.',
    setAiOAuthPending: 'Complete sign-in in your browser.',
    setAiOAuthConnected: 'Connected to ChatGPT',
    setAiOAuthDisconnected: 'Not connected to ChatGPT',
    setAiOAuthError: 'Unable to complete sign-in. Please try again.',
    setAiOAuthOpenBrowser: 'Open browser',
    setAiOAuthStorage: 'Secure credential storage is unavailable.',
    setAiOAuthPort: 'The sign-in port is busy. Close other sign-in windows and retry.',
  ...
  ja: {
    ...
    easyDocConnect: 'スマートフォンを接続',
    easyDocManage: 'スマートフォンを管理',
    easyDocConnected: '接続済み',
    easyDocWaiting: 'スマートフォンを待機中',
    easyDocPairHelp: 'スマートフォンのカメラでQRコードを読み取り、EasyDocで開いてください。',
    easyDocAutoOpen: '受信したファイルを自動で開く',
    easyDocDisconnect: '接続解除',
    ...
    setSecAbout: '情報',
    setSecAiModel: 'AIモデル',
    setAiAuthMethod: '認証方法',
    setAiOAuthHint: 'ChatGPT アカウントでプランに含まれるモデルを使用します。',
    setAiOAuthPending: 'ブラウザーでログインを完了してください。',
    setAiOAuthConnected: 'ChatGPT に接続済み',
    setAiOAuthDisconnected: 'ChatGPT に未接続',
    setAiOAuthError: 'ログインできませんでした。もう一度お試しください。',
    setAiOAuthOpenBrowser: 'ブラウザーを開く',
    setAiOAuthStorage: '安全な認証情報ストレージを利用できません。',
    setAiOAuthPort: 'ログイン用ポートが使用中です。他のログイン画面を閉じて再試行してください。',
  ...
  ko: {
    ...
    newPdf: 'AI PDF',
    openLocal: '로컬 파일 열기',
    easyDocConnect: '휴대폰 연결',
    easyDocManage: '휴대폰 관리',
    easyDocConnected: '연결됨',
    easyDocWaiting: '휴대폰 연결 대기',
    easyDocPairHelp: '휴대폰 카메라로 QR을 스캔한 뒤 EasyDoc에서 여세요.',
    easyDocAutoOpen: '수신한 파일 자동으로 열기',
    easyDocDisconnect: '연결 해제',
    ...
    setSecAbout: '정보',
    setSecAiModel: 'AI 모델',
    setAiAuthMethod: '인증 방식',
    setAiOAuthHint: 'ChatGPT 계정으로 구독에서 제공하는 모델을 사용합니다.',
    setAiOAuthPending: '브라우저에서 로그인을 완료해 주세요.',
    setAiOAuthConnected: 'ChatGPT 연결됨',
    setAiOAuthDisconnected: 'ChatGPT에 연결되지 않음',
    setAiOAuthError: '로그인을 완료하지 못했습니다. 다시 시도해 주세요.',
    setAiOAuthOpenBrowser: '브라우저 열기',
    setAiOAuthStorage: '안전한 인증정보 저장소를 사용할 수 없습니다.',
    setAiOAuthPort: '로그인 포트가 사용 중입니다. 다른 로그인 창을 닫고 다시 시도해 주세요.',
    setAiProvider: '제공업체',
    setAiModelId: '모델',
    setAiApiKey: 'API 키',
  ...
  fr: {
    ...
    easyDocConnect: 'Connecter un téléphone',
    easyDocManage: 'Gérer les téléphones',
    easyDocConnected: 'Connecté',
    easyDocWaiting: 'En attente du téléphone',
    easyDocPairHelp:
      'Scannez ce QR code avec l’appareil photo du téléphone, puis ouvrez-le dans EasyDoc.',
    easyDocAutoOpen: 'Ouvrir automatiquement les fichiers reçus',
    easyDocDisconnect: 'Déconnecter',
    ...
    setAiAuthMethod: 'Authentification',
    setAiOAuthHint: 'Utilisez les modèles inclus dans votre offre avec votre compte ChatGPT.',
    setAiOAuthPending: 'Terminez la connexion dans votre navigateur.',
    setAiOAuthConnected: 'Connecté à ChatGPT',
    setAiOAuthDisconnected: 'Non connecté à ChatGPT',
    setAiOAuthError: 'Connexion impossible. Réessayez.',
    setAiOAuthOpenBrowser: 'Ouvrir le navigateur',
    setAiOAuthStorage: 'Le stockage sécurisé des identifiants est indisponible.',
    setAiOAuthPort:
      'Le port de connexion est occupé. Fermez les autres fenêtres de connexion et réessayez.',
  ...
  de: {
    ...
    easyDocConnect: 'Smartphone verbinden',
    easyDocManage: 'Smartphones verwalten',
    easyDocConnected: 'Verbunden',
    easyDocWaiting: 'Warten auf Smartphone',
    easyDocPairHelp:
      'Scanne diesen QR-Code mit der Smartphone-Kamera und öffne ihn dann in EasyDoc.',
    easyDocAutoOpen: 'Empfangene Dateien automatisch öffnen',
    easyDocDisconnect: 'Trennen',
    ...
    setAiAuthMethod: 'Authentifizierung',
    setAiOAuthHint: 'Nutzen Sie die Modelle Ihres Abos mit Ihrem ChatGPT-Konto.',
    setAiOAuthPending: 'Schließen Sie die Anmeldung im Browser ab.',
    setAiOAuthConnected: 'Mit ChatGPT verbunden',
    setAiOAuthDisconnected: 'Nicht mit ChatGPT verbunden',
    setAiOAuthError: 'Anmeldung fehlgeschlagen. Bitte erneut versuchen.',
    setAiOAuthOpenBrowser: 'Browser öffnen',
    setAiOAuthStorage: 'Der sichere Zugangsdaten-Speicher ist nicht verfügbar.',
    setAiOAuthPort:
      'Der Anmeldeport ist belegt. Schließen Sie andere Anmeldefenster und versuchen Sie es erneut.',
  ...
  es: {
    ...
    easyDocConnect: 'Conectar teléfono',
    easyDocManage: 'Gestionar teléfonos',
    easyDocConnected: 'Conectado',
    easyDocWaiting: 'Esperando el teléfono',
    easyDocPairHelp: 'Escanea este código QR con la cámara del teléfono y ábrelo en EasyDoc.',
    easyDocAutoOpen: 'Abrir automáticamente los archivos recibidos',
    easyDocDisconnect: 'Desconectar',
    ...
    setAiAuthMethod: 'Autenticación',
    setAiOAuthHint: 'Usa los modelos incluidos en tu plan con tu cuenta de ChatGPT.',
    setAiOAuthPending: 'Completa el inicio de sesión en el navegador.',
    setAiOAuthConnected: 'Conectado a ChatGPT',
    setAiOAuthDisconnected: 'Sin conexión con ChatGPT',
    setAiOAuthError: 'No se pudo iniciar sesión. Inténtalo de nuevo.',
    setAiOAuthOpenBrowser: 'Abrir navegador',
    setAiOAuthStorage: 'El almacenamiento seguro de credenciales no está disponible.',
    setAiOAuthPort:
      'El puerto de inicio de sesión está ocupado. Cierra las otras ventanas e inténtalo de nuevo.',
  ...
  th: {
    ...
    easyDocConnect: 'เชื่อมต่อโทรศัพท์',
    easyDocManage: 'จัดการโทรศัพท์',
    easyDocConnected: 'เชื่อมต่อแล้ว',
    easyDocWaiting: 'รอโทรศัพท์',
    easyDocPairHelp: 'สแกน QR นี้ด้วยกล้องโทรศัพท์ แล้วเปิดใน EasyDoc',
    easyDocAutoOpen: 'เปิดไฟล์ที่ได้รับโดยอัตโนมัติ',
    easyDocDisconnect: 'ยกเลิกการเชื่อมต่อ',
    ...
    setAiAuthMethod: 'วิธีการยืนยันตัวตน',
    setAiOAuthHint: 'ใช้โมเดลที่รวมอยู่ในแผนของคุณผ่านบัญชี ChatGPT',
    setAiOAuthPending: 'ลงชื่อเข้าใช้ให้เสร็จในเบราว์เซอร์',
    setAiOAuthConnected: 'เชื่อมต่อกับ ChatGPT แล้ว',
    setAiOAuthDisconnected: 'ยังไม่ได้เชื่อมต่อกับ ChatGPT',
    setAiOAuthError: 'ลงชื่อเข้าใช้ไม่สำเร็จ โปรดลองอีกครั้ง',
    setAiOAuthOpenBrowser: 'เปิดเบราว์เซอร์',
    setAiOAuthStorage: 'ไม่สามารถใช้ที่เก็บข้อมูลรับรองที่ปลอดภัยได้',
    setAiOAuthPort: 'พอร์ตลงชื่อเข้าใช้กำลังถูกใช้งาน ปิดหน้าต่างลงชื่อเข้าใช้อื่นแล้วลองใหม่',
  ...
  id: {
    ...
    easyDocConnect: 'Hubungkan ponsel',
    easyDocManage: 'Kelola ponsel',
    easyDocConnected: 'Terhubung',
    easyDocWaiting: 'Menunggu ponsel',
    easyDocPairHelp: 'Pindai kode QR ini dengan kamera ponsel, lalu buka di EasyDoc.',
    easyDocAutoOpen: 'Buka file yang diterima secara otomatis',
    easyDocDisconnect: 'Putuskan',
    ...
    setAiAuthMethod: 'Autentikasi',
    setAiOAuthHint: 'Gunakan model dalam paket Anda melalui akun ChatGPT.',
    setAiOAuthPending: 'Selesaikan masuk di browser Anda.',
    setAiOAuthConnected: 'Terhubung ke ChatGPT',
    setAiOAuthDisconnected: 'Belum terhubung ke ChatGPT',
    setAiOAuthError: 'Tidak dapat masuk. Silakan coba lagi.',
    setAiOAuthOpenBrowser: 'Buka browser',
    setAiOAuthStorage: 'Penyimpanan kredensial aman tidak tersedia.',
    setAiOAuthPort: 'Port masuk sedang digunakan. Tutup jendela masuk lainnya dan coba lagi.',
  ...
  ru: {
    ...
    easyDocConnect: 'Подключить телефон',
    easyDocManage: 'Управление телефонами',
    easyDocConnected: 'Подключено',
    easyDocWaiting: 'Ожидание телефона',
    easyDocPairHelp: 'Отсканируйте QR-код камерой телефона и откройте его в EasyDoc.',
    easyDocAutoOpen: 'Автоматически открывать полученные файлы',
    easyDocDisconnect: 'Отключить',
    ...
    setAiAuthMethod: 'Аутентификация',
    setAiOAuthHint: 'Используйте модели вашего тарифа через аккаунт ChatGPT.',
    setAiOAuthPending: 'Завершите вход в браузере.',
    setAiOAuthConnected: 'Подключено к ChatGPT',
    setAiOAuthDisconnected: 'Нет подключения к ChatGPT',
    setAiOAuthError: 'Не удалось войти. Попробуйте ещё раз.',
    setAiOAuthOpenBrowser: 'Открыть браузер',
    setAiOAuthStorage: 'Безопасное хранилище учётных данных недоступно.',
    setAiOAuthPort: 'Порт входа занят. Закройте другие окна входа и повторите попытку.',
  ...
  ar: {
    ...
    easyDocConnect: 'توصيل الهاتف',
    easyDocManage: 'إدارة الهواتف',
    easyDocConnected: 'متصل',
    easyDocWaiting: 'في انتظار الهاتف',
    easyDocPairHelp: 'امسح رمز QR بكاميرا الهاتف، ثم افتحه في EasyDoc.',
    easyDocAutoOpen: 'فتح الملفات المستلمة تلقائيًا',
    easyDocDisconnect: 'قطع الاتصال',
    ...
    setAiAuthMethod: 'المصادقة',
    setAiOAuthHint: 'استخدم النماذج المتاحة في خطتك عبر حساب ChatGPT.',
    setAiOAuthPending: 'أكمل تسجيل الدخول في المتصفح.',
    setAiOAuthConnected: 'متصل بـ ChatGPT',
    setAiOAuthDisconnected: 'غير متصل بـ ChatGPT',
    setAiOAuthError: 'تعذر تسجيل الدخول. حاول مرة أخرى.',
    setAiOAuthOpenBrowser: 'فتح المتصفح',
    setAiOAuthStorage: 'التخزين الآمن لبيانات الاعتماد غير متاح.',
    setAiOAuthPort: 'منفذ تسجيل الدخول مشغول. أغلق نوافذ تسجيل الدخول الأخرى وحاول مجددًا.',
  ...
  pt: {
    ...
    easyDocConnect: 'Conectar celular',
    easyDocManage: 'Gerenciar celulares',
    easyDocConnected: 'Conectado',
    easyDocWaiting: 'Aguardando celular',
    easyDocPairHelp: 'Escaneie este QR code com a câmera do celular e abra no EasyDoc.',
    easyDocAutoOpen: 'Abrir arquivos recebidos automaticamente',
    easyDocDisconnect: 'Desconectar',
    ...
    setSecAbout: 'Sobre',
    setSecAiModel: 'Modelo de IA',
    setAiAuthMethod: 'Autenticação',
    setAiOAuthHint: 'Use os modelos incluídos no seu plano com sua conta ChatGPT.',
    setAiOAuthPending: 'Conclua o login no navegador.',
    setAiOAuthConnected: 'Conectado ao ChatGPT',
    setAiOAuthDisconnected: 'Não conectado ao ChatGPT',
    setAiOAuthError: 'Não foi possível entrar. Tente novamente.',
    setAiOAuthOpenBrowser: 'Abrir navegador',
    setAiOAuthStorage: 'O armazenamento seguro de credenciais está indisponível.',
    setAiOAuthPort:
      'A porta de login está ocupada. Feche outras janelas de login e tente novamente.',
  ...
  it: {
    ...
    easyDocConnect: 'Collega telefono',
    easyDocManage: 'Gestisci telefoni',
    easyDocConnected: 'Connesso',
    easyDocWaiting: 'In attesa del telefono',
    easyDocPairHelp:
      'Scansiona questo codice QR con la fotocamera del telefono, poi aprilo in EasyDoc.',
    easyDocAutoOpen: 'Apri automaticamente i file ricevuti',
    easyDocDisconnect: 'Disconnetti',
    ...
    setAiAuthMethod: 'Autenticazione',
    setAiOAuthHint: 'Usa i modelli inclusi nel tuo piano con il tuo account ChatGPT.',
    setAiOAuthPending: 'Completa l’accesso nel browser.',
    setAiOAuthConnected: 'Connesso a ChatGPT',
    setAiOAuthDisconnected: 'Non connesso a ChatGPT',
    setAiOAuthError: 'Accesso non riuscito. Riprova.',
    setAiOAuthOpenBrowser: 'Apri browser',
    setAiOAuthStorage: 'L’archivio sicuro delle credenziali non è disponibile.',
    setAiOAuthPort:
      'La porta di accesso è occupata. Chiudi le altre finestre di accesso e riprova.',
    setAiProvider: 'Provider',
  ...
  pl: {
    ...
    easyDocConnect: 'Połącz telefon',
    easyDocManage: 'Zarządzaj telefonami',
    easyDocConnected: 'Połączono',
    easyDocWaiting: 'Oczekiwanie na telefon',
    easyDocPairHelp: 'Zeskanuj ten kod QR aparatem telefonu, a następnie otwórz go w EasyDoc.',
    easyDocAutoOpen: 'Automatycznie otwieraj odebrane pliki',
    easyDocDisconnect: 'Rozłącz',
    ...
    setSecAiModel: 'Model AI',
    setAiAuthMethod: 'Uwierzytelnianie',
    setAiOAuthHint: 'Korzystaj z modeli swojego planu za pomocą konta ChatGPT.',
    setAiOAuthPending: 'Dokończ logowanie w przeglądarce.',
    setAiOAuthConnected: 'Połączono z ChatGPT',
    setAiOAuthDisconnected: 'Brak połączenia z ChatGPT',
    setAiOAuthError: 'Nie udało się zalogować. Spróbuj ponownie.',
    setAiOAuthOpenBrowser: 'Otwórz przeglądarkę',
    setAiOAuthStorage: 'Bezpieczny magazyn poświadczeń jest niedostępny.',
    setAiOAuthPort: 'Port logowania jest zajęty. Zamknij inne okna logowania i spróbuj ponownie.',
  ...
  nl: {
    ...
    easyDocConnect: 'Telefoon verbinden',
    easyDocManage: 'Telefoons beheren',
    easyDocConnected: 'Verbonden',
    easyDocWaiting: 'Wachten op telefoon',
    easyDocPairHelp: 'Scan deze QR-code met de telefooncamera en open hem daarna in EasyDoc.',
    easyDocAutoOpen: 'Ontvangen bestanden automatisch openen',
    easyDocDisconnect: 'Verbinding verbreken',
    ...
    setSecAbout: 'Over',
    setSecAiModel: 'AI-model',
    setAiAuthMethod: 'Authenticatie',
    setAiOAuthHint: 'Gebruik de modellen van je abonnement met je ChatGPT-account.',
    setAiOAuthPending: 'Voltooi het aanmelden in je browser.',
    setAiOAuthConnected: 'Verbonden met ChatGPT',
    setAiOAuthDisconnected: 'Niet verbonden met ChatGPT',
    setAiOAuthError: 'Aanmelden mislukt. Probeer het opnieuw.',
    setAiOAuthOpenBrowser: 'Browser openen',
    setAiOAuthStorage: 'Veilige opslag van inloggegevens is niet beschikbaar.',
    setAiOAuthPort:
      'De aanmeldpoort is bezet. Sluit andere aanmeldvensters en probeer het opnieuw.',
    setAiProvider: 'Provider',
    setAiModelId: 'Model',
  ...
  ms: {
    ...
    easyDocConnect: 'Sambungkan telefon',
    easyDocManage: 'Urus telefon',
    easyDocConnected: 'Disambungkan',
    easyDocWaiting: 'Menunggu telefon',
    easyDocPairHelp: 'Imbas kod QR ini dengan kamera telefon, kemudian buka dalam EasyDoc.',
    easyDocAutoOpen: 'Buka fail diterima secara automatik',
    easyDocDisconnect: 'Putuskan sambungan',
    dropToOpenTitle: 'Lepaskan untuk membuka',
    greetMorning: 'Selamat pagi',
    ...
    setSecAbout: 'Perihal',
    setSecAiModel: 'Model AI',
    setAiAuthMethod: 'Pengesahan',
    setAiOAuthHint: 'Gunakan model dalam pelan anda melalui akaun ChatGPT.',
    setAiOAuthPending: 'Lengkapkan log masuk dalam pelayar anda.',
    setAiOAuthConnected: 'Disambungkan ke ChatGPT',
    setAiOAuthDisconnected: 'Belum disambungkan ke ChatGPT',
    setAiOAuthError: 'Tidak dapat log masuk. Sila cuba lagi.',
    setAiOAuthOpenBrowser: 'Buka pelayar',
    setAiOAuthStorage: 'Storan kelayakan selamat tidak tersedia.',
    setAiOAuthPort:
      'Port log masuk sedang digunakan. Tutup tetingkap log masuk lain dan cuba lagi.',
    setAiProvider: 'Penyedia',
    setAiModelId: 'Model',
    setAiApiKey: 'Kunci API',
  ...
  he: {
    ...
    easyDocConnect: 'חיבור טלפון',
    easyDocManage: 'ניהול טלפונים',
    easyDocConnected: 'מחובר',
    easyDocWaiting: 'ממתין לטלפון',
    easyDocPairHelp: 'סרוק את קוד ה-QR במצלמת הטלפון ואז פתח אותו ב-EasyDoc.',
    easyDocAutoOpen: 'פתיחת קבצים שהתקבלו אוטומטית',
    easyDocDisconnect: 'ניתוק',
    ...
    setAiAuthMethod: 'אימות',
    setAiOAuthHint: 'השתמשו במודלים הזמינים בתוכנית שלכם באמצעות חשבון ChatGPT.',
    setAiOAuthPending: 'השלימו את הכניסה בדפדפן.',
    setAiOAuthConnected: 'מחובר ל-ChatGPT',
    setAiOAuthDisconnected: 'לא מחובר ל-ChatGPT',
    setAiOAuthError: 'לא ניתן להשלים את הכניסה. נסו שוב.',
    setAiOAuthOpenBrowser: 'פתיחת הדפדפן',
    setAiOAuthStorage: 'אחסון מאובטח של פרטי הכניסה אינו זמין.',
    setAiOAuthPort: 'יציאת הכניסה תפוסה. סגרו חלונות כניסה אחרים ונסו שוב.',
    setAiProvider: 'ספק',
    setAiModelId: 'מודל',
  ...
  hi: {
    ...
    easyDocConnect: 'फ़ोन कनेक्ट करें',
    easyDocManage: 'फ़ोन प्रबंधित करें',
    easyDocConnected: 'कनेक्टेड',
    easyDocWaiting: 'फ़ोन की प्रतीक्षा',
    easyDocPairHelp: 'फ़ोन कैमरे से यह QR कोड स्कैन करें, फिर EasyDoc में खोलें।',
    easyDocAutoOpen: 'प्राप्त फ़ाइलें अपने आप खोलें',
    easyDocDisconnect: 'डिस्कनेक्ट करें',
    ...
    setAiAuthMethod: 'प्रमाणीकरण',
    setAiOAuthHint: 'अपने ChatGPT खाते से अपनी योजना में उपलब्ध मॉडल इस्तेमाल करें।',
    setAiOAuthPending: 'अपने ब्राउज़र में साइन इन पूरा करें।',
    setAiOAuthConnected: 'ChatGPT से जुड़ा हुआ',
    setAiOAuthDisconnected: 'ChatGPT से जुड़ा नहीं है',
    setAiOAuthError: 'साइन इन पूरा नहीं हो सका। फिर कोशिश करें।',
    setAiOAuthOpenBrowser: 'ब्राउज़र खोलें',
    setAiOAuthStorage: 'सुरक्षित क्रेडेंशियल स्टोरेज उपलब्ध नहीं है।',
    setAiOAuthPort: 'साइन-इन पोर्ट व्यस्त है। दूसरी साइन-इन विंडो बंद करके फिर कोशिश करें।',
  ...
  'zh-TW': {
    ...
    easyDocConnect: '連接手機',
    easyDocManage: '管理手機',
    easyDocConnected: '已連接',
    easyDocWaiting: '等待手機',
    easyDocPairHelp: '使用手機相機掃描此 QR 碼，然後在 EasyDoc 中開啟。',
    easyDocAutoOpen: '自動開啟收到的檔案',
    easyDocDisconnect: '解除連接',
    ...
    setSecAbout: '關於',
    setSecAiModel: 'AI 模型',
    setAiAuthMethod: '驗證方式',
    setAiOAuthHint: '透過 ChatGPT 帳號使用訂閱方案提供的模型。',
    setAiOAuthPending: '請在瀏覽器中完成登入。',
    setAiOAuthConnected: '已連接 ChatGPT',
    setAiOAuthDisconnected: '尚未連接 ChatGPT',
    setAiOAuthError: '無法完成登入，請再試一次。',
    setAiOAuthOpenBrowser: '開啟瀏覽器',
    setAiOAuthStorage: '安全憑證儲存空間無法使用。',
    setAiOAuthPort: '登入連接埠正在使用中，請關閉其他登入視窗後再試。',
    setAiProvider: '模型服務商',
    setAiModelId: '模型',
    setAiApiKey: 'API Key',
